    ...
    return (
      ...
      >
        <mask
          ...
          height={16}
        >
          <rect width={16} height={16} fill="url(#pattern0_1_656)" />
        </mask>
        <g mask="url(#mask0_1_656)">
          <rect x={0.178131} width={18.6667} height={18.6667} fill="#D9D9D9" />
        </g>
        <defs>
          <pattern
            id="pattern0_1_656"
            ...
            height={1}
          >
            <use xlinkHref="#image0_1_656" transform="scale(0.0111111)" />
          </pattern>
          <image
            id="image0_1_656"
            width={90}
